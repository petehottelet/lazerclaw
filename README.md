...
- **Pen Tool** — Full Bezier path editor with sub-tools (rectangle, ellipse, polygon, line, arc, spiral)
...
### AI-Powered
- **Dr. Claw** — AI design assistant chatbot (powered by Anthropic Claude) that can add shapes, text, images, and modify your canvas by voice command
...
│   │   ├── AgentChat.jsx   Dr. Claw AI chatbot + animated gem
│   │   ├── ShapesPanel.jsx Shapes, vectors browser
...
├── public/                 Static assets (logos, shapes)
