  ...
  return (
    <>
      ...
      <button
        ...
        disabled={busy}
        className={`
          relative flex items-center gap-2 ${collapse >= 1 ? 'px-2.5' : 'px-5'} py-2 rounded text-sm font-black uppercase transition-all duration-200 overflow-visible shrink-0
      ...
      >
        ...
        <span className="download-label">{statusText}</span>
        {mp4Loading && (
